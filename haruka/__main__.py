...
def send_start(bot, update):
    ...
    text = "Hey there! My name is Shaktimaan - I'm here to help you manage your groups!\n\
Click Help button to find out more about how to use me to my full potential.\n\n"

    text += "This bot is developed by @Sike9\n\n\
    Special Thanks to @Prakasaka 🙂\n\n\
    Having issues? Join- @ShaktimaanSupport"
    ...
    keyboard += [[InlineKeyboardButton(text="➕Add Me To Groups➕", url="https://t.me/ShaktimaanRobot?startgroup=true")]]
